...
class Checkpoint extends SpriteAnimationComponent
  ...
  FutureOr<void> onLoad() {
    ...
    animation = SpriteAnimation.fromFrameData(
      game.images
          .fromCache('Checkpoints/Checkpoint/Checkpoint (No Flag).png'),
  ...
  void _reachedCheckpoint() async {
    animation = SpriteAnimation.fromFrameData(
      game.images.fromCache(
          'Checkpoints/Checkpoint/Checkpoint (Flag Out) (64x64).png'),
      SpriteAnimationData.sequenced(
        amount: 26,
        stepTime: 0.05,
        textureSize: Vector2.all(64),
    ...
    animation = SpriteAnimation.fromFrameData(
      game.images.fromCache(
          'Checkpoints/Checkpoint/Checkpoint (Flag Idle)(64x64).png'),
      SpriteAnimationData.sequenced(
        amount: 10,
        stepTime: 0.05,
        textureSize: Vector2.all(64),
